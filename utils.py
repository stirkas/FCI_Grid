...
DataArray: TypeAlias = npt.NDArray[np.float64]
...
DEFAULT_XGUARDS: int = 2
DEFAULT_YGUARDS: int = 1
DEFAULT_ZGUARDS: int = 0
DEFAULT_NX: int = 64
DEFAULT_NZ: int = DEFAULT_NX + 2*DEFAULT_XGUARDS #Because MZG = 0 but MXG = 2. TODO: MZG fix/grid dim fix?
DEFAULT_NY: int = 16
#Default values for perp domains. Use for consistency around the code.
DEFAULT_START: float = 0.0
DEFAULT_STOP:  float = 1.0
#Default guard cell info for BOUT++.
DEBUG_FLAG = False
